...
let UserController = class UserController {
    ...
    getCurrent(req) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.userService.findById(req.user.id);
        });
    }
    editCurrent(req, user) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.userService.updateCurrent(req.user.id, user);
        });
    }
    getById(id) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    edit(id, user) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.userService.edit(id, user);
        });
    }
};
__decorate([
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], UserController.prototype, "editCurrent", null);
__decorate([
    common_1.Get(":id"),
