...
let SpeechController = class SpeechController {
    ...
    getCurrent(audioInput) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.speechService.fromArrayBuffer(audioInput.audio);
        });
    }
};
__decorate([
    common_1.Post("prononciation"),
    __param(0, common_1.Body()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], SpeechController.prototype, "getCurrent", null);
SpeechController = __decorate([
    swagger_1.ApiUseTags("api/speech"),
    common_1.Controller("api/speech"),
